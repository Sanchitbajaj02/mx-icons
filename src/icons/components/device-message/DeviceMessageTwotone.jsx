...
export default function DeviceMessageTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M7.40039 22H14.6004" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M15.6947 7.25H15.7037" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M12.8959 7.25H12.9049" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
