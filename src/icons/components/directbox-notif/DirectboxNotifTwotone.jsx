...
export default function DirectboxNotifTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path opacity="0.4" d="M10.5508 9.22998H13.8808" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path opacity="0.4" d="M9.7207 6.22998H14.7207" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
