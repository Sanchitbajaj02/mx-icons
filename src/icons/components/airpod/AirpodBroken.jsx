...
export default function AirpodBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M21.2309 8.91992H17.1309" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M6.86953 8.91992H2.76953" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
