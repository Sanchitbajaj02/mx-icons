...
export default function Icon3dDSquareBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M6.70117 9.26001L12.0012 12.33L17.2612 9.28001" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M12.002 17.7701V12.3201" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
