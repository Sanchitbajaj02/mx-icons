...
export default function Hierarchy3Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M11.17 12H9C6.8 12 5 11 5 8V16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
