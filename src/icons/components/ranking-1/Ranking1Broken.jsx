...
export default function Ranking1Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M15.3302 12C15.3302 10.9 14.4302 10 13.3302 10H10.6602C9.56016 10 8.66016 10.9 8.66016 12V22H15.3302V16" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
