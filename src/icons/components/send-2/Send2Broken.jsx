...
export default function Send2Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M10.1094 13.6501L13.6894 10.0601" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
