...
export default function Hierarchy2Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M5.13086 15C5.58086 13.25 7.18086 11.95 9.07086 11.96L12.5009 11.97C13.3509 11.97 14.1709 11.8 14.9009 11.48" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
