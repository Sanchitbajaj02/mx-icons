...
export default function GalleryBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M11 8C11 9.1 10.1 10 9 10C7.9 10 7 9.1 7 8C7 6.9 7.9 6 9 6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
