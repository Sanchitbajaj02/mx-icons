...
export default function GalleryEditBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M18.6191 3.11011C18.9291 4.21011 19.7891 5.07011 20.8891 5.38011" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
