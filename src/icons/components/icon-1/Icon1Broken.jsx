...
export default function Icon1Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M2 14H13C14.1 14 15 13.1 15 12V5H16.84C17.2 5 17.55 5.10002 17.85 5.27002" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M6.06897 6.03992L3.95898 3.92993" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M6.03967 3.95996L3.92969 6.06995" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
