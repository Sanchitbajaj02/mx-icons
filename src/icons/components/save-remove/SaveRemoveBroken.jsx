...
export default function SaveRemoveBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M7.58984 13.4101L10.4098 10.5901" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M10.4098 13.4101L7.58984 10.5901" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
