...
export default function Icon3dDCubeScanTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<g opacity="0.4">
<path d="M6.69922 9.26025L11.9992 12.3303L17.2592 9.28027" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M12 17.7703V12.3203" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
