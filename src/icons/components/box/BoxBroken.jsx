...
export default function BoxBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M16.9998 13.2401V9.58014L10.9297 6.07013L9.87976 5.47009L7.50977 4.1001" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
