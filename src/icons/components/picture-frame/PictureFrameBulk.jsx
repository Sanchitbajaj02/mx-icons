...
export default function PictureFrameBulk({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M14.78 22H13.18L10.99 13.16L2.21002 15.72L2 15.79V14.22L10.63 11.7L8.21997 2H9.78003L14.78 22Z" fill="currentColor"/>
    </Icon>
  );
}
