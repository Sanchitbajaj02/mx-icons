...
export default function ScanBarcodeBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M13.5 9V7C13.5 6 14 5.5 15 5.5H17C18 5.5 18.5 6 18.5 7V9C18.5 10 18 10.5 17 10.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M7 13.5H9C10 13.5 10.5 14 10.5 15V17C10.5 18 10 18.5 9 18.5H7C6 18.5 5.5 18 5.5 17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
