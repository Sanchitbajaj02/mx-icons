...
export default function HeadphonesBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M15.5 10V7.21997" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M15.5 22V13" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
