...
export default function Building3Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M19.9805 22.01V18" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
