...
export default function LoginTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M12.6504 8.65039L16.0004 12.0004L12.6504 15.3504" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</g>
    </Icon>
  );
}
