...
export default function ScissorTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M17.5002 8.7002L10.1602 14.1902" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
