...
export default function MessageText1Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M15.9902 8H17.0002" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M7 8H12.51" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
