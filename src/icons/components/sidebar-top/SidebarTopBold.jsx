...
export default function SidebarTopBold({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M20.9493 4.13C20.6593 3.71 20.2893 3.34 19.8693 3.05C18.9193 2.36 17.6793 2 16.1893 2H7.8093C4.3693 2 2.2393 3.94 2.0293 7.22H21.9793C21.8993 5.99 21.5493 4.95 20.9493 4.13Z" fill="currentColor"/>
