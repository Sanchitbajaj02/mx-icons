...
export default function KeyBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M6.89062 17.49L9.19062 19.79" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
