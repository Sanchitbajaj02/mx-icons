...
export default function ForwardItemBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M22.0005 5.76999V9C22.0005 11.69 20.9205 12.77 18.2305 12.77H17.3805V10.39C17.3805 7.70001 16.3005 6.62 13.6105 6.62H11.2305V5.76999C11.2305 3.07999 12.3105 2 15.0005 2H18.2305C20.9205 2 22.0005 3.07999 22.0005 5.76999Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M12.77 17.38V18.23C12.77 20.92 11.69 22 9 22H5.77C3.08 22 2 20.92 2 18.23V15C2 12.31 3.08 11.23 5.77 11.23H6.62" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
