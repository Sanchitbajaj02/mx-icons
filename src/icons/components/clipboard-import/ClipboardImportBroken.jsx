...
export default function ClipboardImportBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M14 22H9C4 22 3 20 3 16V14.01" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
