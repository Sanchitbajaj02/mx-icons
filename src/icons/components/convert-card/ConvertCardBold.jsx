...
export default function ConvertCardBold({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M12.5 5.80859C12.22 5.80859 12 6.02859 12 6.30859V7.30859V8.29859C12 10.0586 12.44 10.4986 14.22 10.4986H19.78C21.56 10.4986 22 10.0586 22 8.29859V7.30859V6.30859C22 6.02859 21.78 5.80859 21.5 5.80859H12.5Z" fill="currentColor"/>
...
<path d="M2.5 17.3086C2.22 17.3086 2 17.5286 2 17.8086V18.8086V19.7986C2 21.5586 2.44 21.9986 4.22 21.9986H9.78C11.56 21.9986 12 21.5586 12 19.7986V18.8086V17.8086C12 17.5286 11.78 17.3086 11.5 17.3086H2.5Z" fill="currentColor"/>
    </Icon>
  );
}
