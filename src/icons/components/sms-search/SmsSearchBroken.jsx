...
export default function SmsSearchBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M12 20.4999H7C4 20.4999 2 18.9999 2 15.4999V12.4399" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
