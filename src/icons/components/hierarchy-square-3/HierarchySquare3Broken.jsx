...
export default function HierarchySquare3Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M7.88086 13.8001C8.15086 12.7501 9.11084 11.9701 10.2408 11.9801L12.3008 11.9901C13.8708 12.0001 15.2109 10.9901 15.7009 9.58008" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
