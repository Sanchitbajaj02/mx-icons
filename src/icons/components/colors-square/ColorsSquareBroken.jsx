...
export default function ColorsSquareBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M2 13.2V15C2 20 4 22 9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
