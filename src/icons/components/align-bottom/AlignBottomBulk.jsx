...
export default function AlignBottomBulk({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path opacity="0.4" d="M7.48 14.3799H8.52C10.11 14.3799 10.75 13.7699 10.75 12.2599V5.37988H5.25V12.2599C5.26 13.7699 5.9 14.3799 7.48 14.3799Z" fill="currentColor"/>
