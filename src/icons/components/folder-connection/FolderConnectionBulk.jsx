...
export default function FolderConnectionBulk({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M19 8.29999V12.5C19 15.3 18.3 16 15.5 16H8.5C5.7 16 5 15.3 5 12.5V5.5C5 2.7 5.7 2 8.5 2H9.54999C10.6 2 10.83 2.31003 11.23 2.84003L12.28 4.23999C12.55 4.58999 12.7 4.79999 13.4 4.79999H15.5C18.3 4.79999 19 5.49999 19 8.29999Z" fill="currentColor"/>
    </Icon>
  );
}
