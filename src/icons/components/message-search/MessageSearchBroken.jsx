...
export default function MessageSearchBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M21.4 18.2C21.4 19.97 19.97 21.4 18.2 21.4C16.43 21.4 15 19.97 15 18.2C15 16.43 16.43 15 18.2 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
