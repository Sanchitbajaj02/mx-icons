...
export default function ArrowCircleUpBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M8.4707 13.26L12.0007 9.73999L15.5307 13.26" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
