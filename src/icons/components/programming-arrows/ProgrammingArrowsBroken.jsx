...
export default function ProgrammingArrowsBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M5 12V17.5C5 18.6 5.9 19.5 7 19.5H12.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
