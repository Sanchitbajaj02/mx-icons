...
export default function VolumeLow1Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M19.3301 8C21.1101 10.37 21.1101 13.63 19.3301 16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
