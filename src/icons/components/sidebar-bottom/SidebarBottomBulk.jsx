...
export default function SidebarBottomBulk({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M22 15.2798H2V16.1898C2 16.3898 2.01 16.5898 2.02 16.7798H21.97C21.99 16.5898 22 16.3898 22 16.1898V15.2798Z" fill="currentColor"/>
