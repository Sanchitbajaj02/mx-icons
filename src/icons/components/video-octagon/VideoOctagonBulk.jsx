...
export default function VideoOctagonBulk({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M9.75 11.9999V10.7999C9.75 9.25989 10.84 8.62993 12.17 9.39993L13.21 9.9999L14.25 10.5999C15.58 11.3699 15.58 12.6299 14.25 13.3999L13.21 13.9999L12.17 14.5999C10.84 15.3699 9.75 14.7399 9.75 13.1999V11.9999Z" fill="currentColor"/>
    </Icon>
  );
}
