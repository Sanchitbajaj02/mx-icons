...
export default function VideoRemoveBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M19.7003 19.6801L17.3203 17.3" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M19.6808 17.3201L17.3008 19.7001" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
