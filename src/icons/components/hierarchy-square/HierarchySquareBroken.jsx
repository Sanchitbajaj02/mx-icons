...
export default function HierarchySquareBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M7.55078 10.2V14.3999" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
