...
export default function DataBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M11 12V17C11 19 12 20 14 20H18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M18 4H14C12 4 11 5 11 7V7.97998" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
