...
export default function MessageRemoveTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M6.06921 18.5402L3.94922 16.4302" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M6.04968 16.46L3.92969 18.5699" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
