...
export default function BriefcaseBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M2.61914 11.27C4.86914 12.81 7.40914 13.74 9.99914 14.03" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
