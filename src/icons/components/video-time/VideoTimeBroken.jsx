...
export default function VideoTimeBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M18.7809 17.0901V18.7801L17.3809 19.6201" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
