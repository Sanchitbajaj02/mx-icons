...
export default function RotateLeftTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M7.86914 5.31982L11.2391 7.77982" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
