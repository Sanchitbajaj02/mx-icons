...
export default function BluetoothRectangleBold({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M12.9004 16.3302L14.5704 14.9402L12.9004 13.4102V16.3302Z" fill="currentColor"/>
<path d="M12.9004 10.5919L14.5704 9.06188L12.9004 7.67188V10.5919Z" fill="currentColor"/>
