...
export default function MessageEditTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M12.168 8.58008C12.608 10.1501 13.838 11.3901 15.418 11.8301" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</g>
    </Icon>
  );
}
