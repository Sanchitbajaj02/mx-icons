...
export default function GpsSlashBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M4.77 10.01C4.59 10.64 4.5 11.31 4.5 12C4.5 14.01 5.29 15.84 6.58 17.19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M17.21 6.6C15.86 5.3 14.02 4.5 12 4.5C10.08 4.5 8.33 5.22 7 6.41" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
