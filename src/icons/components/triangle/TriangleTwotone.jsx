...
export default function TriangleTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<g opacity="0.4">
<path d="M21.4405 19.9996L12.0005 13.3896L2.56055 19.9996" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
