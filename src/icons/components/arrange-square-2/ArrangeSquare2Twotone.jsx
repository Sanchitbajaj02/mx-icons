...
export default function ArrangeSquare2Twotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<g opacity="0.4">
<path d="M10.1806 17.1504L7.14062 14.1104" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
