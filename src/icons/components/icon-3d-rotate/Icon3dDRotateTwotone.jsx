...
export default function Icon3dDRotateTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M6.70117 9.25977L12.0012 12.3298L17.2612 9.27976" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M12.002 17.7698V12.3198" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
