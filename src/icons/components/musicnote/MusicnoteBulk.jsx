...
export default function MusicnoteBulk({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M12.7207 8.27002V18C12.7207 20.62 10.5907 22.75 7.9707 22.75C5.3507 22.75 3.2207 20.62 3.2207 18C3.2207 15.38 5.3507 13.25 7.9707 13.25C9.2307 13.25 10.3707 13.75 11.2207 14.55V7.77002L12.7207 8.27002Z" fill="currentColor"/>
    </Icon>
  );
}
