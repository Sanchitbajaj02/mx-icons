...
export default function GlassTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path opacity="0.4" d="M5.93945 13.1199C5.93945 13.1199 8.99945 12.9999 11.9995 13.9999C14.9995 14.9999 17.8295 13.1099 17.8295 13.1099" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
