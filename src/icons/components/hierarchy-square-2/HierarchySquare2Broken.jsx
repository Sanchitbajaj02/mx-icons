...
export default function HierarchySquare2Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M7.80078 10.2V14.3999" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M7.88086 10.2C8.15086 11.25 9.11084 12.0299 10.2408 12.0199L12.3008 12.0099C13.8708 11.9999 15.2109 13.01 15.7009 14.42" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
