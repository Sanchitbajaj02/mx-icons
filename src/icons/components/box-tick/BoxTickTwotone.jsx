...
export default function BoxTickTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M17.4395 18.0303L18.4495 18.9902L20.5395 16.9702" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<g opacity="0.4">
