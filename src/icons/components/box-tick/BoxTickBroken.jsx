...
export default function BoxTickBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M17.4395 18.03L18.4495 18.99L20.5395 16.97" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
