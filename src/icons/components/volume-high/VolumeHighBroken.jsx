...
export default function VolumeHighBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M19.8301 18.5C21.2801 16.57 22.0001 14.29 22.0001 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M19.8301 5.5C20.4201 6.28 20.8801 7.12 21.2301 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
