...
export default function Note2Twotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path opacity="0.4" d="M12.6406 8.52979L17.4906 9.75979" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path opacity="0.4" d="M11.6602 12.3999L14.5602 13.1399" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
