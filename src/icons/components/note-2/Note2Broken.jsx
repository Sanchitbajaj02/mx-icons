...
export default function Note2Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M12.6406 8.53003L17.4906 9.76003" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
