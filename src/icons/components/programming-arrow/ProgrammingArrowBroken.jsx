...
export default function ProgrammingArrowBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M5.25 2C3.46 2 2 3.46 2 5.25C2 7.04 3.46 8.5 5.25 8.5C7.04 8.5 8.5 7.04 8.5 5.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
