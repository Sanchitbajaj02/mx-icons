...
export default function RotateRightTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M16.1298 5.31982L12.7598 7.77982" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
