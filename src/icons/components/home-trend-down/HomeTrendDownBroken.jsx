...
export default function HomeTrendDownBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M11.17 14L10.7 14.7L7.5 11.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M16.5 16.5L14.99 14.99L14 14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
