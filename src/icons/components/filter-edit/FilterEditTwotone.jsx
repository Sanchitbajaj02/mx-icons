...
export default function FilterEditTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M16.5801 12.3901C16.8801 13.4701 17.72 14.3101 18.8 14.6101" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
