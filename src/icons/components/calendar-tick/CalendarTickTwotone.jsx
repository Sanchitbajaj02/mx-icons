...
export default function CalendarTickTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M16.4404 19L17.4304 19.99L19.5604 18.02" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
