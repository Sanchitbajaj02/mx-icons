...
export default function GalleryExportBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M2 12.98V15C2 20 4 22 9 22H15C20 22 22 20 22 15V10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
