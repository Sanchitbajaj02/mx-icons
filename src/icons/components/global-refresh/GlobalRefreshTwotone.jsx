...
export default function GlobalRefreshTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M20.0401 14.8003L18.5801 15.8603" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
