...
export default function HierarchyBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M5.13086 9C5.58086 10.75 7.18086 12.05 9.07086 12.04L12.5009 12.03C13.3409 12.03 14.1309 12.2 14.8609 12.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
