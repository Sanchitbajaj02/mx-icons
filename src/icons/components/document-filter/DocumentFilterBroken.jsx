...
export default function DocumentFilterBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M21.9992 9C21.9992 5.88 21.2192 3.91999 19.4092 2.89999C18.8992 2.60999 17.8792 2.38999 16.9492 2.23999" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M2 12V15C2 20 4 22 9 22H15C20 22 22 20 22 15V13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
