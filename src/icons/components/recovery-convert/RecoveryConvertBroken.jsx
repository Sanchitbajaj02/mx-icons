...
export default function RecoveryConvertBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M18.5004 8.68V11.41C18.5004 13.69 17.5904 14.6 15.3104 14.6H14.6004V12.58C14.6004 10.31 13.6904 9.4 11.4104 9.4H9.40039V8.68C9.40039 6.4 10.3104 5.5 12.5904 5.5H15.3204C17.5904 5.5 18.5004 6.41 18.5004 8.68Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
