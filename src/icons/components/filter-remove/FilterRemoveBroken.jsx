...
export default function FilterRemoveBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M18.1291 13.51L15.6191 16.02" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
