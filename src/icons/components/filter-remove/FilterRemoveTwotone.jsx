...
export default function FilterRemoveTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M18.1487 15.99L15.6387 13.48" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M18.1291 13.5098L15.6191 16.0198" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
