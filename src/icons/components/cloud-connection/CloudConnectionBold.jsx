...
export default function CloudConnectionBold({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M19.2007 14.7811C18.3407 15.5711 17.2007 16.0111 16.0307 16.0011H6.3707C2.3007 15.7111 2.2907 9.80114 6.3707 9.51114H6.4107C3.6207 1.75114 15.4107 -1.33886 16.7607 6.80114C20.5307 7.28114 22.0607 12.2911 19.2007 14.7811Z" fill="currentColor"/>
