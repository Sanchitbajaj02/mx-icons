...
export default function Maximize1Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M18 12V10M16.95 12H18H16.95ZM6 12H12H14H6ZM6 12V10V12ZM6 12V14V12ZM18 12V14V12Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
