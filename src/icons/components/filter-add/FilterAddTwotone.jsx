...
export default function FilterAddTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M18.6594 14.73H15.1094" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M16.8789 13V16.55" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
