...
export default function HeartAddTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M18.9902 17.2598H15.4102" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M17.1992 15.5098V19.0997" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
