...
export default function CallIncomingBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M16.1992 7.8H20.9992M16.1992 4.95V3V4.95ZM16.1992 7.8V7.01V7.8Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
