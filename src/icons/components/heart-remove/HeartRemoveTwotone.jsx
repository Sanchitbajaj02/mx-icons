...
export default function HeartRemoveTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M18.4792 18.54L15.9492 16" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
