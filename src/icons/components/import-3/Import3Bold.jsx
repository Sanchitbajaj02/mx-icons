...
export default function Import3Bold({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M12.6797 3.98828C12.6797 3.57828 12.3397 3.23828 11.9297 3.23828C11.5197 3.23828 11.1797 3.57828 11.1797 3.98828V9.88828H12.6797V3.98828Z" fill="currentColor"/>
    </Icon>
  );
}
