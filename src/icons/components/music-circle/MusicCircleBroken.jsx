...
export default function MusicCircleBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M5.7204 19.75C5.2504 19.37 4.80039 18.95 4.40039 18.49" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
