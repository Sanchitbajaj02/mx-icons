...
export default function NotificationBingBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M15.3299 18.8201C15.3299 20.6501 13.8299 22.1501 11.9999 22.1501C11.0899 22.1501 10.2499 21.7701 9.64992 21.1701C9.04992 20.5701 8.66992 19.7301 8.66992 18.8201" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10"/>
    </Icon>
  );
}
