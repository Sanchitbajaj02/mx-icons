...
export default function Map1Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M8.56055 4V17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M15.7305 6.62012V20.0001" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </Icon>
  );
}
