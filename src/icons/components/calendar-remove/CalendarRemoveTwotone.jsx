...
export default function CalendarRemoveTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M19.0692 20.11L16.9492 18" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M19.0497 18.02L16.9297 20.14" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
