...
export default function GalleryFavoriteBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
...
<path d="M2 12.98V15C2 20 4 22 9 22H15C20 22 22 20 22 15V11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M12 2H9C4 2 2 4 2 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
